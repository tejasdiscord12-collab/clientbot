        ...
        if (interaction.isStringSelectMenu()) {
            if (interaction.customId === 'ticket_select') {
                try {
                    ...
                    const existingTicket = db.getOpenTicket(guild.id, user.id);
                    ...
                    const ticketCount = db.getTicketCount(guild.id);
                    ...
                    db.createTicket(guild.id, ticketNumber, ticketChannel.id, ticketType, user.id);
        ...
        if (interaction.isButton()) {
            ...
            if (customId === 'ticket_close') {
                try {
                    ...
                    const ticket = db.getTicketByChannel(guild.id, channel.id);
                    ...
                    db.closeTicket(guild.id, channel.id);
            ...
            if (customId === 'ticket_claim') {
                try {
                    ...
                    // Update ticket
                    db.claimTicket(guild.id, channel.id, user.id);
